...
const clubs = [
  { name: "CLB TEC",    events: 12, students: 420, status: "Active"  },
  { name: "CLB SIC",    events:  8, students: 210, status: "Active"  },
  { name: "CLB HRC",    events:  5, students: 150, status: "Pending" },
  { name: "CLB MAC",    events:  9, students: 310, status: "Active"  },
];
